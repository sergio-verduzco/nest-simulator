...
/*
 * There are three scenarios, in which AcemModule can be loaded by NEST:
 *
...
mynest::AcemModule acemmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::AcemModule::AcemModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::AcemModule::name( void ) const
{
  return std::string( "acemmodule" ); // Return name of the module
}

const std::string
mynest::AcemModule::commandstring( void ) const
{
  // Instruct the interpreter to load acemmodule-init.sli
  return std::string( "(acemmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::AcemModule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< aeif_cond_exp_multisynapse >(
