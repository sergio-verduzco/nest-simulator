...
#ifndef AEIF_COND_EXP_M_H
#define AEIF_COND_EXP_M_H
...
/* BeginDocumentation
Name: aeif_cond_exp_multisynapse - Conductance based exponential integrate-and-fire neuron
 ...
 */
extern "C" int aeif_cond_exp_multisynapse_dynamics( double, const double*, double*, void* );
 ...
 * @param void* Pointer to model neuron instance.
 */
/* I commented this out because it's not implemented in the cpp file
 * -Sergio
 */
//extern "C" int
//aeif_cond_exp_multisynapse_dynamics_DT0( double, const double*, double*, void* );


class aeif_cond_exp_multisynapse : public Archiving_Node
{
...
private:
  ...
  friend int aeif_cond_exp_multisynapse_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class RecordablesMap< aeif_cond_exp_multisynapse >;
  friend class UniversalDataLogger< aeif_cond_exp_multisynapse >;
...
public:
  ...
  static RecordablesMap< aeif_cond_exp_multisynapse > recordablesMap_;
};

inline port
aeif_cond_exp_multisynapse::send_test_event( Node& target,
  rport receptor_type,
  synindex,
  bool )
{
...
inline port
aeif_cond_exp_multisynapse::handles_test_event( DataLoggingRequest& dlr,
  rport receptor_type )
{
  if ( receptor_type != 0 )
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cond_exp_multisynapse::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
inline void
aeif_cond_exp_multisynapse::set_status( const DictionaryDatum& d )
{
