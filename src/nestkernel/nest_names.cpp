...
const Name EXC_FAST( "EXC_FAST" );
const Name EXC_SLOW( "EXC_SLOW" );
...
const Name g_ex_fast( "g_ex_fast" );
const Name g_ex_slow( "g_ex_slow" );
...
const Name tau_syn_ex_fast( "tau_syn_ex_fast" );
const Name tau_syn_ex_slow( "tau_syn_ex_slow" );
